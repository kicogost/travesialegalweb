import { Shield, TrendingUp, Clock, MapPin, Globe, Briefcase, BarChart2, CheckCircle, ArrowRight, MessageCircle } from 'lucide-react'
  ...
  return (
    <>
      ...
      <section style={{ background: 'var(--navy-faint)', padding: '96px 0', overflow: 'hidden' }}>
        ...
        {/* Trustindex Google Reviews Widget — isolated in iframe to prevent CSS leaks */}
        <div className="container">
          <iframe
            srcDoc={`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>body{margin:0;font-family:system-ui,sans-serif;}</style></head><body><script defer async src="https://cdn.trustindex.io/loader.js?27af4d269bde48296466c8a080a"></script><div data-widget-id="27af4d269bde48296466c8a080a"></div></body></html>`}
